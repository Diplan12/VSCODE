def tablaMultiplicar(n):
    ...
    if n <= 10:
        for numero in range(1,11,1):
            #print(f"{n} x {numero} = " + str(numero*n))
            tabla.append(f"{n} x {numero} = " + str(numero*n))
    else:
        print("NUMERO EXCEDIO EL RANGO")
...
def leertabla(n):
    ...
    try:
        ...
        print("NO SE ENCUENTRA EL ARCHIVO CON LA TABLA DEL "+str(n))
...
numeroDos=int(input("INTRODUZCA OTRO NUMERO DEL 1 AL 10 "))
#tablaMultiplicar(numero)
#leertabla(numero)
leertablaN(numero,numeroDos)
#print(texto)"""

"""Escribir un programa para gestionar un listín telefónico con los nombres y los teléfonos de los clientes de una 
empresa. El programa incorporar funciones crear el fichero con el listín si no existe, para consultar el teléfono de 
un cliente, añadir el teléfono de un nuevo cliente y eliminar el teléfono de un cliente. El listín debe estar guardado 
en el fichero de texto listin.txt donde el nombre del cliente 
